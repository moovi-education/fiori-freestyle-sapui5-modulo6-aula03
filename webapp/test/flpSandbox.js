					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding Element",
									"targetURL": "#moovim06a03-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"moovim06a03-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.m06a03",
									"url": sap.ui.require.toUrl("moovi/m06a03")
								}
							}
						}
					}
